...
> Not: Kayıt e-posta + şifre ile anında olur (e-posta doğrulama kodu yok),
> bu yüzden mail servisi / ayarı gerekmez.
...
> Sadece bu iki değişken yeter. Kayıt e-posta + şifre ile anında olur,
> e-posta doğrulama (kod gönderme) yok — yani mail ayarı gerekmez.
...
## 6. Test et
- Adresi aç → kayıt ol (kullanıcı adı + e-posta + şifre) → hesap anında açılır.
